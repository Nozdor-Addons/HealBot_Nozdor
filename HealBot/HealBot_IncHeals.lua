    ...
    elseif shGUID then
        if hbShinkWrapGUID[shGUID] then
            ...
            elseif UnitExists("focus") and r==strsub(UnitGUID("focus"),5,5) and r=="0" and t==strsub(UnitGUID("focus"),13) then
                s=UnitGUID("focus")
            elseif UnitExists("focus") and r==strsub(UnitGUID("focus"),5,5) and r=="4" and t==strsub(UnitGUID("focus"),4,10) then
                s=HealBot_retPetGUID(UnitGUID("focus"))
            elseif UnitExists("focus") and r==strsub(UnitGUID("focus"),5,5) and t==strsub(UnitGUID("focus"),4,10) then
                s=UnitGUID("focus")
            elseif UnitExists("target") and r==strsub(UnitGUID("target"),5,5) and r=="0" and t==strsub(UnitGUID("target"),13) then  
                s=UnitGUID("target")
            elseif UnitExists("target") and r==strsub(UnitGUID("target"),5,5) and r=="4" and t==strsub(UnitGUID("target"),4,10) then   
                s=HealBot_retPetGUID(UnitGUID("target"))
            elseif UnitExists("target") and r==strsub(UnitGUID("target"),5,5) and t==strsub(UnitGUID("target"),4,10) then  
                s=UnitGUID("target")
            end
