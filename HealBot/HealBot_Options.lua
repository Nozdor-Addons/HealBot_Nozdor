...
local text=nil
local unique=nil
local x,y,z,k,j=nil,nil,nil,nil,nil
local textures=nil
local texturesIndex={}
local fonts=nil
local fontsIndex={}
...
function HealBot_Options_Pct_OnLoad_MinMax(self,vText,Min,Max,Step)
    ...
    getglobal(self:GetName().."Text"):SetText(vText);
    getglobal(self:GetName().."Low"):SetText(i);
    getglobal(self:GetName().."High"):SetText(j);
...
function HealBot_Options_valNoCols_OnLoad(self,Min,Max)
    getglobal(self:GetName().."Text"):SetText(HealBot_Options_SetNoColsText);
    getglobal(self:GetName().."Low"):SetText(Min);
    getglobal(self:GetName().."High"):SetText(Max);
    self:SetMinMaxValues(Min,Max);
    self:SetValueStep(1);
...
function HealBot_Options_val2_OnLoad(self,vText,Min,Max,Step,vDiv)
    ...
    getglobal(self:GetName().."Text"):SetText(vText);
    getglobal(self:GetName().."Low"):SetText(Min/vDiv);
    getglobal(self:GetName().."High"):SetText(Max/vDiv);
    self:SetMinMaxValues(Min,Max);
    self:SetValueStep(Step);
end
...
function HealBot_Options_valtime_OnLoad(self,vText,Min,Max,Step,secsOnly)
    ...
    if secsOnly then
        ...
        getglobal(self:GetName().."Low"):SetText(Min/60);
        getglobal(self:GetName().."High"):SetText(Max/60);
    end
    self:SetMinMaxValues(Min,Max);
    self:SetValueStep(Step);
end
...
function HealBot_Options_Pct_OnValueChanged(self)
    ...
    getglobal(self:GetName().."Text"):SetText(self.text .. " (" .. pct .. "%)");
...
function HealBot_Options_WarningSound_OnValueChanged(self)
    if self:GetValue() > 0 and sounds then
        ...
        getglobal(self:GetName().."Text"):SetText(self.text .. " ".. self:GetValue()..": " ..sounds[self:GetValue()]);
    else
...
function HealBot_Options_BarTextureS_OnValueChanged(self)
    if self:GetValue() > 0 and textures then
        ...
        getglobal(self:GetName().."Text"):SetText(self.text .. " "..self:GetValue()..": " .. textures[self:GetValue()]);
    else
        getglobal(self:GetName().."Text"):SetText(self.text);
    end    
...
function HealBot_BarButtonIconScale_OnValueChanged(self)
    ...
    getglobal(self:GetName().."Text"):SetText(self.text .. ": " .. val);
    HealBot_setOptions_Timer(150)
end
...
function HealBot_BarButtonIconTextDurationTime_OnValueChanged(self)
    ...
    getglobal(self:GetName().."Text"):SetText(self.text .. ": " .. Healbot_Config_Skins.IconTextDurationShow[Healbot_Config_Skins.Current_Skin]);
end
...
function HealBot_BarButtonIconTextDurationWarn_OnValueChanged(self)
    ...
    getglobal(self:GetName().."Text"):SetText(self.text .. ": " .. Healbot_Config_Skins.IconTextDurationWarn[Healbot_Config_Skins.Current_Skin]);
end
...
function HealBot_Options_HeadFontNameS_OnValueChanged(self)
    if self:GetValue() > 0 and fonts then
        ...
        getglobal(self:GetName().."Text"):SetText(self.text .. " ".. self:GetValue()..": " ..fonts[self:GetValue()]);
    else
        getglobal(self:GetName().."Text"):SetText(self.text);
    end   
...
function HealBot_Options_HeadFontHeightS_OnValueChanged(self)
    ...
    getglobal(self:GetName().."Text"):SetText(self.text .. ": " .. self:GetValue());
    HealBot_setOptions_Timer(150)
    HealBot_setOptions_Timer(160)
end
...
function HealBot_Options_BarNumColsS_OnValueChanged(self)
    ...
    getglobal(self:GetName().."Text"):SetText(HealBot_Options_SetNoColsText() .. ": " .. self:GetValue());
    Delay_RecalcParty=2
end
...
function HealBot_Options_TextAlign_OnValueChanged(self)
    getglobal(self:GetName().."Text"):SetText(self.text .. " ".. self:GetValue()..": " ..HealBot_Alignment[self:GetValue()]);
...
function HealBot_Options_SetBarsTextColour()
    if Healbot_Config_Skins.SetClassColourText[Healbot_Config_Skins.Current_Skin]==0 then
        ...
        sbR, sbG, sbB = HealBot_Action_ClassColour(HealBot_PlayerGUID)
        HealBot_EnTextColorpickt:SetTextColor(
            sbR,
            sbG,
            sbB,
...
function HealBot_Options_BuffTimer_OnValueChanged(self,bufftype)
    ...
    if mins==0 then
        getglobal(self:GetName().."Text"):SetText(self.text .. ": " .. secs .." secs");
    else
        val=val/60;
        getglobal(self:GetName().."Text"):SetText(self.text .. ": " .. mins ..":".. secs .." mins");
    end
...
function HealBot_Options_CastNotify_OnClick(self,id)
    if id>0 and id~=HealBot_Options_StorePrev["CastNotify"] then
        getglobal("HealBot_Options_CastNotify"..HealBot_Options_StorePrev["CastNotify"]):SetChecked(nil);
    ...
    if Healbot_Config_Skins.CastNotify[Healbot_Config_Skins.Current_Skin]>0 then
        getglobal("HealBot_Options_CastNotify"..Healbot_Config_Skins.CastNotify[Healbot_Config_Skins.Current_Skin]):SetChecked(1);
    end
end
...
function HealBot_Options_BarClassCustom_OnClick(self,id)
    ...
    getglobal("HealBot_Options_BarClassCustomColour"..HealBot_Options_StorePrev["ClassCustom"]):SetChecked(nil);
    ...
    if Healbot_Config_Skins.SetBarCustomColour[Healbot_Config_Skins.Current_Skin]>0 then
        getglobal("HealBot_Options_BarClassCustomColour"..Healbot_Config_Skins.SetBarCustomColour[Healbot_Config_Skins.Current_Skin]):SetChecked(1);
...
function HealBot_HoTonBar_OnClick(self,id)
    ...
    getglobal("HealBot_BarButtonShowHoTonBar"..HealBot_Options_StorePrev["HoTonBar"]):SetChecked(nil);
    ...
    if Healbot_Config_Skins.HoTonBar[Healbot_Config_Skins.Current_Skin]>0 then
        getglobal("HealBot_BarButtonShowHoTonBar"..Healbot_Config_Skins.HoTonBar[Healbot_Config_Skins.Current_Skin]):SetChecked(1);
...
function HealBot_HoTposBar_OnClick(self,id)
    ...
    getglobal("HealBot_BarButtonShowHoTposBar"..HealBot_Options_StorePrev["HoTposBar"]):SetChecked(nil);
    ...
    if Healbot_Config_Skins.HoTposBar[Healbot_Config_Skins.Current_Skin]>0 then
        getglobal("HealBot_BarButtonShowHoTposBar"..Healbot_Config_Skins.HoTposBar[Healbot_Config_Skins.Current_Skin]):SetChecked(1);
...
function HealBot_Options_ShowClassOnBarType_OnClick(self,id)
    ...
    getglobal("HealBot_Options_ShowClassOnBarType"..HealBot_Options_StorePrev["ShowClassOnBarType"]):SetChecked(nil);
    ...
    if Healbot_Config_Skins.ShowClassType[Healbot_Config_Skins.Current_Skin]>0 then
        getglobal("HealBot_Options_ShowClassOnBarType"..Healbot_Config_Skins.ShowClassType[Healbot_Config_Skins.Current_Skin]):SetChecked(1);
...
function HealBot_Options_BarHealthNumFormat1_OnSelect()
    Healbot_Config_Skins.BarHealthNumFormat1[Healbot_Config_Skins.Current_Skin] = this:GetID()
    hbBarHealthNumFormatTxt=this:GetText()
...
function HealBot_Options_BarHealthNumFormat2_OnSelect()
    Healbot_Config_Skins.BarHealthNumFormat2[Healbot_Config_Skins.Current_Skin] = this:GetID()
...
function HealBot_Options_BarHealthNumFormatAggro_OnSelect()
    Healbot_Config_Skins.BarHealthNumFormatAggro[Healbot_Config_Skins.Current_Skin] = this:GetID()
...
function HealBot_Options_BarHealthIncHeal_OnSelect()
    Healbot_Config_Skins.BarHealthIncHeals[Healbot_Config_Skins.Current_Skin] = this:GetID()
...
function HealBot_Options_BarHealthType_OnSelect()
    Healbot_Config_Skins.BarHealthType[Healbot_Config_Skins.Current_Skin] = this:GetID()
...
function HealBot_Options_HealCommMethod_OnSelect()
    x=HealBot_Config.HealCommMethod
    HealBot_Config.HealCommMethod = this:GetID()
...
function HealBot_Options_CastButton_OnSelect()
    HealBot_Options_ComboButtons_Button = this:GetID()
...
function HealBot_Options_ButtonCastMethod_OnSelect()
    x=HealBot_Config.ButtonCastMethod
    HealBot_Config.ButtonCastMethod = this:GetID()
...
function HealBot_Options_MouseWheelModKey_OnSelect()
    HealBot_Config.HealBot_MouseWheelMod = this:GetID()
...
function HealBot_Options_hbCommands_OnSelect()
    HealBot_Options_StorePrev["hbCommands"] = this:GetID()
...
function HealBot_Options_ExtraSort_OnSelect()
    Healbot_Config_Skins.ExtraOrder[Healbot_Config_Skins.Current_Skin] = this:GetID();
...
function HealBot_Options_ExtraSubSort_OnSelect()
    Healbot_Config_Skins.ExtraSubOrder[Healbot_Config_Skins.Current_Skin] = this:GetID();
...
function HealBot_Options_SelectHealSpellsCombo_OnSelect()
    hbHelpHealSelect = this:GetText()
    HealBot_SelectHealSpellsCombo = this:GetID()
...
function HealBot_Options_SelectOtherSpellsCombo_OnSelect()
    HealBot_SelectOtherSpellsCombo = this:GetID()
    hbHelpOtherSelect=this:GetText()
...
function HealBot_Options_SelectMacrosCombo_OnSelect()
    HealBot_SelectMacrosCombo = this:GetID()
    hbHelpMacroSelect=this:GetText()
...
function HealBot_Options_SelectItemsCombo_OnSelect()
    HealBot_SelectItemsCombo = this:GetID()
    hbHelpItemSelect=this:GetText()
...
function HealBot_Options_SelectCmdsCombo_OnSelect()
    HealBot_SelectCmdsCombo = this:GetID()
    hbHelpCmdsSelect=this:GetText()
...
function HealBot_Options_ActionAnchor_OnSelect()
    Healbot_Config_Skins.Panel_Anchor[Healbot_Config_Skins.Current_Skin] = this:GetID()
...
function HealBot_Options_ActionBarsAnchor_OnSelect()
    Healbot_Config_Skins.Bars_Anchor[Healbot_Config_Skins.Current_Skin] = this:GetID()
    HealBot_CheckActionFrame()
...
function HealBot_Options_Class_HoTctlName_OnSelect()
    HealBot_Globals.HoTindex = this:GetID()
    HealBot_Globals.HoTname = this:GetText()
...
function HealBot_Options_Class_HoTctlAction_OnSelect()
    local hbClass=strsub(HealBot_PlayerClassEN,1,4)
    HealBot_Globals.WatchHoT[hbClass][HealBot_Globals.HoTname]=this:GetID()
...
function HealBot_Options_FilterHoTctl_OnSelect()
    HealBot_Options_StorePrev["FilterHoTctlID"] = this:GetID()
    HealBot_Options_FilterHoTctl_Refresh(true)
    HealBot_Options_StorePrev["FilterHoTctlName"]=this.value
...
function HealBot_Options_SkinDefault_OnSelect()
    hbSkinDefaultID = this:GetID()
...
function HealBot_Options_AggroAlertLevel_OnSelect()
    Healbot_Config_Skins.AggroAlertLevel[Healbot_Config_Skins.Current_Skin]=this:GetID()
...
function HealBot_Options_EmergencyFilter_OnSelect()
    Healbot_Config_Skins.EmergIncMonitor[Healbot_Config_Skins.Current_Skin] = this:GetID()
...
function HealBot_Options_Skins_OnSelect()
    Healbot_Config_Skins.Skin_ID = this:GetID()
    HealBot_Options_Skins_Refresh(true)
    if this:GetID()>=1 then
        HealBot_Options_Set_Current_Skin(this:GetText())
    end
end
...
function HealBot_Options_ShareSkin_OnSelect()
    hbShareSkin = this:GetID()
    hbCurUnitName = this:GetText()
...
function HealBot_Options_BuffTxt1_OnSelect()
    BuffTextClass = HealBot_Config.HealBotBuffText
    BuffTextClass[HealBot_Options_getDropDownId_bySpec(1)] = this:GetText()
...
function HealBot_Options_BuffTxt2_OnSelect()
    BuffTextClass = HealBot_Config.HealBotBuffText
    BuffTextClass[HealBot_Options_getDropDownId_bySpec(2)] = this:GetText()
...
function HealBot_Options_BuffTxt3_OnSelect()
    BuffTextClass = HealBot_Config.HealBotBuffText
    BuffTextClass[HealBot_Options_getDropDownId_bySpec(3)] = this:GetText()
...
function HealBot_Options_BuffTxt4_OnSelect()
    BuffTextClass = HealBot_Config.HealBotBuffText
    BuffTextClass[HealBot_Options_getDropDownId_bySpec(4)] = this:GetText()
...
function HealBot_Options_BuffTxt5_OnSelect()
    BuffTextClass = HealBot_Config.HealBotBuffText
    BuffTextClass[HealBot_Options_getDropDownId_bySpec(5)] = this:GetText()
...
function HealBot_Options_BuffTxt6_OnSelect()
    BuffTextClass = HealBot_Config.HealBotBuffText
    BuffTextClass[HealBot_Options_getDropDownId_bySpec(6)] = this:GetText()
...
function HealBot_Options_BuffTxt7_OnSelect()
    BuffTextClass = HealBot_Config.HealBotBuffText
    BuffTextClass[HealBot_Options_getDropDownId_bySpec(7)] = this:GetText()
...
function HealBot_Options_BuffTxt8_OnSelect()
    BuffTextClass = HealBot_Config.HealBotBuffText
    BuffTextClass[HealBot_Options_getDropDownId_bySpec(8)] = this:GetText()
...
function HealBot_Options_BuffTxt9_OnSelect()
    BuffTextClass = HealBot_Config.HealBotBuffText
    BuffTextClass[HealBot_Options_getDropDownId_bySpec(9)] = this:GetText()
    HealBot_Options_BuffTxt9_Refresh(true)
    HealBot_setOptions_Timer(40)
end

function HealBot_Options_BuffTxt10_OnSelect()
    BuffTextClass = HealBot_Config.HealBotBuffText
    BuffTextClass[HealBot_Options_getDropDownId_bySpec(10)] = this:GetText()
...
function HealBot_Options_BuffGroups1_OnSelect()
    BuffDropDownClass = HealBot_Config.HealBotBuffDropDown
    BuffDropDownClass[HealBot_Options_getDropDownId_bySpec(1)] = this:GetID()
...
function HealBot_Options_BuffGroups2_OnSelect()
    BuffDropDownClass = HealBot_Config.HealBotBuffDropDown
    BuffDropDownClass[HealBot_Options_getDropDownId_bySpec(2)] = this:GetID()
...
function HealBot_Options_BuffGroups3_OnSelect()
    BuffDropDownClass = HealBot_Config.HealBotBuffDropDown
    BuffDropDownClass[HealBot_Options_getDropDownId_bySpec(3)] = this:GetID()
...
function HealBot_Options_BuffGroups4_OnSelect()
    BuffDropDownClass = HealBot_Config.HealBotBuffDropDown
    BuffDropDownClass[HealBot_Options_getDropDownId_bySpec(4)] = this:GetID()
...
function HealBot_Options_BuffGroups5_OnSelect()
    BuffDropDownClass = HealBot_Config.HealBotBuffDropDown
    BuffDropDownClass[HealBot_Options_getDropDownId_bySpec(5)] = this:GetID()
...
function HealBot_Options_BuffGroups6_OnSelect()
    BuffDropDownClass = HealBot_Config.HealBotBuffDropDown
    BuffDropDownClass[HealBot_Options_getDropDownId_bySpec(6)] = this:GetID()
...
function HealBot_Options_BuffGroups7_OnSelect()
    BuffDropDownClass = HealBot_Config.HealBotBuffDropDown
    BuffDropDownClass[HealBot_Options_getDropDownId_bySpec(7)] = this:GetID()
...
function HealBot_Options_BuffGroups8_OnSelect()
    BuffDropDownClass = HealBot_Config.HealBotBuffDropDown
    BuffDropDownClass[HealBot_Options_getDropDownId_bySpec(8)] = this:GetID()
...
function HealBot_Options_BuffGroups9_OnSelect()
    BuffDropDownClass = HealBot_Config.HealBotBuffDropDown
    BuffDropDownClass[HealBot_Options_getDropDownId_bySpec(9)] = this:GetID()
    HealBot_Options_BuffGroups9_Refresh(true)
    ClickedBuffGroupDD=9
    HealBot_setOptions_Timer(40)
end

function HealBot_Options_BuffGroups10_OnSelect()
    BuffDropDownClass = HealBot_Config.HealBotBuffDropDown
    BuffDropDownClass[HealBot_Options_getDropDownId_bySpec(10)] = this:GetID()
...
function HealBot_Options_CDCTxt1_OnSelect()
    HealBot_Config.HealBotDebuffText[HealBot_Options_getDropDownId_bySpec(1)] = this:GetText()
    HealBot_Options_CDCTxt1_Refresh(true)
    HealBot_setOptions_Timer(50)
end

function HealBot_Options_CDCTxt2_OnSelect()
    HealBot_Config.HealBotDebuffText[HealBot_Options_getDropDownId_bySpec(2)] = this:GetText()
    HealBot_Options_CDCTxt2_Refresh(true)
    HealBot_setOptions_Timer(50)
end

function HealBot_Options_CDCTxt3_OnSelect()
    HealBot_Config.HealBotDebuffText[HealBot_Options_getDropDownId_bySpec(3)] = this:GetText()
    HealBot_Options_CDCTxt3_Refresh(true)
    HealBot_setOptions_Timer(50)
end

function HealBot_Options_CDCGroups1_OnSelect()
    HealBot_Config.HealBotDebuffDropDown[HealBot_Options_getDropDownId_bySpec(1)] = this:GetID()
...
function HealBot_Options_CDCGroups2_OnSelect()
    HealBot_Config.HealBotDebuffDropDown[HealBot_Options_getDropDownId_bySpec(2)] = this:GetID()
...
function HealBot_Options_CDCGroups3_OnSelect()
    HealBot_Config.HealBotDebuffDropDown[HealBot_Options_getDropDownId_bySpec(3)] = this:GetID()
    HealBot_Options_CDCGroups3_Refresh(true)
    ClickedBuffGroupDD=3
    HealBot_setOptions_Timer(50)
end

function HealBot_Options_CDCPriority1_OnSelect()
    HealBot_Config.HealBotDebuffPriority[HEALBOT_DISEASE_en] = this:GetID()
    HealBot_Options_CDCPriority1_Refresh(true)
    HealBot_Options_setCustomDebuffList()
end

function HealBot_Options_CDCPriority2_OnSelect()
    HealBot_Config.HealBotDebuffPriority[HEALBOT_MAGIC_en] = this:GetID()
    HealBot_Options_CDCPriority2_Refresh(true)
    HealBot_Options_setCustomDebuffList()
end

function HealBot_Options_CDCPriority3_OnSelect()
    HealBot_Config.HealBotDebuffPriority[HEALBOT_POISON_en] = this:GetID()
    HealBot_Options_CDCPriority3_Refresh(true)
    HealBot_Options_setCustomDebuffList()
end

function HealBot_Options_CDCPriority4_OnSelect()
    HealBot_Config.HealBotDebuffPriority[HEALBOT_CURSE_en] = this:GetID()
    HealBot_Options_CDCPriority4_Refresh(true)
    HealBot_Options_setCustomDebuffList()
end

function HealBot_Options_CDCPriorityC_OnSelect()
    if HealBot_Options_StorePrev["CDebuffcustomName"] then
        HealBot_Config.HealBot_Custom_Debuffs[HealBot_Options_StorePrev["CDebuffcustomName"]] = this:GetID()
    end
    HealBot_Options_CDCPriorityC_Refresh(true)
    HealBot_Options_setCustomDebuffList()
end

function HealBot_Options_CDCWarnRange1_OnSelect()
    HealBot_Config.HealBot_CDCWarnRange_Bar = this:GetID()
    HealBot_Options_CDCWarnRange1_Refresh(true)
end

function HealBot_Options_CDCWarnRange2_OnSelect()
    HealBot_Config.HealBot_CDCWarnRange_Aggro = this:GetID()
    HealBot_Options_CDCWarnRange2_Refresh(true)
end

function HealBot_Options_CDCWarnRange3_OnSelect()
    HealBot_Config.HealBot_CDCWarnRange_Screen = this:GetID()
    HealBot_Options_CDCWarnRange3_Refresh(true)
end

function HealBot_Options_CDCWarnRange4_OnSelect()
    HealBot_Config.HealBot_CDCWarnRange_Sound = this:GetID()
...
function HealBot_Options_CDebuffCat_OnSelect()
    HealBot_Options_StorePrev["CDebuffCatID"] = this:GetID()
...
function HealBot_Options_CDebuffTxt1_OnSelect()
    HealBot_Options_StorePrev["CDebuffcustomID"] = this:GetID()
    HealBot_Options_StorePrev["CDebuffcustomName"] = this.value
...
function HealBot_Options_setCustomDebuffList()
        ...
        if customPriority[j] then
            for z, dName in pairs(customPriority[j]) do
                ...
                if customListPos<31 then
                    textname=getglobal("HealBot_Options_CustomDebuff_List"..customListPos)
                    if j<10 then
    ...
    for j=customListPos,30 do
        textname=getglobal("HealBot_Options_CustomDebuff_List"..j)
        textname:SetText(" ")
    end
end
...
StaticPopupDialogs["HEALBOT_OPTIONS_BUFFNAMEDTITLE"] = {
    ...
    button2 = CANCEL,
    OnShow = function()
        getglobal(this:GetName().."WideEditBox"):SetText(HealBot_GuessName())
    end,
    OnAccept = function()
        HealBot_Options_Set_BuffWatchGUID(getglobal(this:GetParent():GetName().."WideEditBox"):GetText())
    end,
    OnCancel = function()
        -- do nothing
    end,
...
function HealBot_Options_OnLoad(self)
  ...
  -- Tabs
    ...
    DoInitTab={[1]=true, [2]=true, [3]=true, [4]=true, [5]=true, [6]=true, [7]=true, [9]=true, [10]=true, }
    getglobal("HealBot_Options_HeadersSkinsFrame"):Hide()
    getglobal("HealBot_Options_IconsSkinsFrame"):Hide()
    getglobal("HealBot_Options_HealingSkinsFrame"):Hide()
    getglobal("HealBot_Options_IncHealsSkinsFrame"):Hide()
    getglobal("HealBot_Options_ChatSkinsFrame"):Hide()
    getglobal("HealBot_Options_BarsSkinsFrame"):Hide()
    getglobal("HealBot_Options_TextSkinsFrame"):Hide()
    getglobal("HealBot_Options_AggroSkinsFrame"):Hide()
    getglobal("HealBot_Options_IconTextSkinsFrame"):Hide()
    getglobal("HealBot_Options_CustomCureFrame"):Hide()
    getglobal("HealBot_Options_WarningCureFrame"):Hide()
    getglobal("HealBot_Options_HealSortFrame"):Hide()
    getglobal("HealBot_Options_HealRaidFrame"):Hide()
    getglobal("HealBot_SkinsFrameSelectGeneralFramef"):SetTextColor(1,1,1,1)
    getglobal("HealBot_SkinsFrameSelectHealingFramef"):SetTextColor(1,1,0,0.92)
    getglobal("HealBot_SkinsFrameSelectIncHealsFramef"):SetTextColor(1,1,0,0.92)
    getglobal("HealBot_SkinsFrameSelectChatFramef"):SetTextColor(1,1,0,0.92)
    getglobal("HealBot_SkinsFrameSelectHeadersFramef"):SetTextColor(1,1,0,0.92)
    getglobal("HealBot_SkinsFrameSelectBarsFramef"):SetTextColor(1,1,0,0.92)
    getglobal("HealBot_SkinsFrameSelectTextFramef"):SetTextColor(1,1,0,0.92)
    getglobal("HealBot_SkinsFrameSelectIconsFramef"):SetTextColor(1,1,0,0.92)
    getglobal("HealBot_SkinsFrameSelectIconTextFramef"):SetTextColor(1,1,0,0.92)
    getglobal("HealBot_SkinsFrameSelectAggroFramef"):SetTextColor(1,1,0,0.92)
    getglobal("HealBot_CureFrameSelectDebuffFramef"):SetTextColor(1,1,1,1)
    getglobal("HealBot_CureFrameSelectCustomFramef"):SetTextColor(1,1,0,0.92)
    getglobal("HealBot_CureFrameSelectWarningFramef"):SetTextColor(1,1,0,0.92)
    getglobal("HealBot_SkinsSubFrameSelectHealAlertFramef"):SetTextColor(1,1,1,1)
    getglobal("HealBot_SkinsSubFrameSelectHealRaidFramef"):SetTextColor(1,1,0,0.92)
    getglobal("HealBot_SkinsSubFrameSelectHealSortFramef"):SetTextColor(1,1,0,0.92)
end
...
function HealBot_Options_SetEFGroups()
    for x=1,8 do
        if Healbot_Config_Skins.ExtraIncGroup[Healbot_Config_Skins.Current_Skin][x] then 
            getglobal("HealBot_Options_EFGroup"..x):SetChecked(1)
        else
            getglobal("HealBot_Options_EFGroup"..x):SetChecked(nil)
        end
    end
end
...
function HealBot_Options_ShowPanel(self, tabNo)
    ...
    if HealBot_Options_CurrentPanel>0 then
        ...
        getglobal("HealBot_OptionsTab"..HealBot_Options_CurrentPanel):Show();
...
function HealBot_Options_ShowSkinsPanel(frameName,barName)
    getglobal(HealBot_Options_StorePrev["CurrentSkinsPanel"]):Hide()
    getglobal(HealBot_Options_StorePrev["CurrentbarName"]):SetStatusBarColor(0.58,0.08,0.08)
    getglobal(HealBot_Options_StorePrev["CurrentbarName"].."f"):SetTextColor(1,1,0,0.92)
    getglobal(frameName):Show()
    getglobal(barName):SetStatusBarColor(1,0.32,0.32)
    getglobal(barName.."f"):SetTextColor(1,1,1,1)
...
function HealBot_Options_ShowCurePanel(frameName,barName)
    getglobal(HealBot_Options_StorePrev["CurrentCurePanel"]):Hide()
    getglobal(HealBot_Options_StorePrev["CurrentCurebarName"]):SetStatusBarColor(0.58,0.08,0.08)
    getglobal(HealBot_Options_StorePrev["CurrentCurebarName"].."f"):SetTextColor(1,1,0,0.92)
    getglobal(frameName):Show()
    getglobal(barName):SetStatusBarColor(1,0.32,0.32)
    getglobal(barName.."f"):SetTextColor(1,1,1,1)
...
function HealBot_Options_ShowHealPanel(frameName,barName)
    getglobal(HealBot_Options_StorePrev["CurrentHealPanel"]):Hide()
    getglobal(HealBot_Options_StorePrev["CurrentHealbarName"]):SetStatusBarColor(0.58,0.08,0.08)
    getglobal(HealBot_Options_StorePrev["CurrentHealbarName"].."f"):SetTextColor(1,1,0,0.92)
    getglobal(frameName):Show()
    getglobal(barName):SetStatusBarColor(1,0.32,0.32)
    getglobal(barName.."f"):SetTextColor(1,1,1,1)
...
function HealBot_Options_DisablePartyFrame()
    ...
    hooksecurefunc("ShowPartyFrame", function()
        for x = 1,4 do
            getglobal("PartyMemberFrame"..x):Hide()
        end
    end)
    for x = 1, 4 do
        f = getglobal("PartyMemberFrame"..x)
        f:Hide()
        f:UnregisterAllEvents()
        getglobal("PartyMemberFrame"..x.."HealthBar"):UnregisterAllEvents()
        getglobal("PartyMemberFrame"..x.."ManaBar"):UnregisterAllEvents()
    end
end
...
function HealBot_Options_EnablePartyFrame()
    ...
    hooksecurefunc("ShowPartyFrame", function()
        for x = 1,4 do
            getglobal("PartyMemberFrame"..x):Show()
        end
    end)
    for x = 1, 4 do
        f = getglobal("PartyMemberFrame"..x)
        ...
        f:RegisterAllEvents()
        getglobal("PartyMemberFrame"..x.."HealthBar"):RegisterAllEvents()
        getglobal("PartyMemberFrame"..x.."ManaBar"):RegisterAllEvents()
    end
end
...
function HealBot_UpdateUsedMedia(event, mediatype, key)
    if mediatype == "statusbar" then
        if Healbot_Config_Skins.headtexture and key == Healbot_Config_Skins.headtexture[Healbot_Config_Skins.Current_Skin] then 
            for x=1,15 do
                h=getglobal("HealBot_Action_Header"..x);
        ...
        if Healbot_Config_Skins.btexture and key == Healbot_Config_Skins.btexture[Healbot_Config_Skins.Current_Skin] then 
            for x=1,51 do
                b=getglobal("HealBot_Action_HealUnit"..x);
